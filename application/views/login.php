...
@media(max-width: 380px) {
  ...
  <div class="wrapper">
    ...
    <input type="hidden" name="<?= $this->security->get_csrf_token_name()?>" value="<?=$this->security->get_csrf_hash();?>" />
        <div class="form-field d-flex align-items-center">
             <span class="far fa-user"></span>
              <input type="enail" name="userName" id="userName" placeholder="Username">
    ...
    <div class="text-center fs-6"> <a href="#">Forget password?</a> or <a href="<?php echo base_url('signup_controller/form')?>">Sign up</a> </div>
</div>
  </body>
</html>
